export const profile = {
  name: "Basavarajsing Bapparagi",
  role: "Aspiring Software Development Engineer (SDE)",
  headline:
    "Aspiring SDE focused on clean, reliable web products (React/Node) and ML-backed demos. Strong in DSA and shipping end-to-end features.",
